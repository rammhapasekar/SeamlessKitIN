...
extension UIViewController {
    ...
    func presentpopupViewController(popupViewController: UIViewController, animationType:SLpopupViewAnimationType, completion:() -> Void) {
        ...
        //print("sourceView :: \(sourceView) popupViewController :: \(popupViewController)")
        ...
        dismissButton.addTarget(self, action: #selector(btnDismissViewControllerWithAnimation), for: .touchUpInside)
    ...
    func fadeView(popupView: UIView, sourceView:UIView, overlayView:UIView) {
        ...
        //        popupView.frame = CGRect((sourceSize.width - popupSize.width)/2,
...
let kpopupAnimationDuration = 0.5
