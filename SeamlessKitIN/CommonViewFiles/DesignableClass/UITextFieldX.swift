...
//        attributedPlaceholder = NSAttributedString(string: placeholder != nil ?  placeholder! : "", attributes:[NSForegroundColorAttributeName: tintColor])
        ...
        attributedText = NSAttributedString(string: text != nil ? text! : "" , attributes:[NSAttributedStringKey.foregroundColor: UIColor.lightText,NSAttributedStringKey.font :UIFont.systemFont(ofSize: 10)])
    }
